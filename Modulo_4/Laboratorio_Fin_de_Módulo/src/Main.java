...
public class Main {
    public static void main(String[] args) {
        ...
        contAdm = 0;
        contAlum = 0;
        System.out.println("Ingrese el nombre, el apellido, o el dni para eliminar los datos de una persona");
        String buscar = scan.next();
        while (true) {
            if (contDir < directores.length) {
                if (directores[contDir].getNombre().equals(buscar) || directores[contDir].getApellido().equals(buscar)
                ...
                if (profesores[contProf].getNombre().equals(buscar) || profesores[contProf].getApellido().equals(buscar)
                ...
                if (profesores[contAdm].getNombre().equals(buscar) || profesores[contAdm].getApellido().equals(buscar)
                ...
                if (profesores[contAlum].getNombre().equals(buscar) || profesores[contAlum].getApellido().equals(buscar)
        ...
        do {
            System.out.println(
                    "Ingrese una opcion para mostrar datos de la lista modificada:\n\t1-Director\n\t2-Profesor\n\t3-Administrativo\n\t4-Alumno\n\t0-Salir");
            opcion = scan.nextInt();
            switch (opcion) {
                case 1:
                    if (contDir < directores.length) {
